...
public:
    ...
    VCTR_COMMON_UNARY_EXPRESSION_MEMBERS (Min)
    ...
    template <size_t n>
    VCTR_FORCEDINLINE static value_type finalizeSIMDReduction (const std::array<value_type, n>& minima)
    {
...
public:
    ...
    VCTR_COMMON_UNARY_EXPRESSION_MEMBERS (MinAbs)
