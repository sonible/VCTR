...
public:
    ...
    requires Config::archX64 && has::getAVX<SrcType> && is::realFloatNumber<value_type>
    {
        ...
        result = Expression::AVX::min (result, Expression::AVX::bitwiseAndNot (src.getAVX (i), avxSignBit));
    }
    ...
    requires Config::archX64 && has::getSSE<SrcType> && is::realFloatNumber<value_type>
    {
        ...
        result = Expression::SSE::min (result, Expression::SSE::bitwiseAndNot (src.getSSE (i), sseSignBit));
    }
