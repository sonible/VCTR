...
public:
    ...
    requires Config::archX64 && has::getAVX<SrcType> && is::realFloatNumber<value_type>
    {
        ...
        result = Expression::AVX::min (result, Expression::AVX::bitwiseAndNot (avxSignBit, src.getAVX (i)));
    }
    ...
    requires Config::archX64 && has::getSSE<SrcType> && is::realFloatNumber<value_type>
    {
        ...
        result = Expression::SSE::min (result, Expression::SSE::bitwiseAndNot (sseSignBit, src.getSSE (i)));
    }
