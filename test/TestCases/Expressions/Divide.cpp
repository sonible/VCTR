...
TEMPLATE_PRODUCT_TEST_CASE ("Divide in place", "[VCTR][divide]", (PlatformVectorOps, VCTR_NATIVE_SIMD), (float, double, int32_t, uint32_t, int64_t, uint64_t, std::complex<float>, std::complex<double>) )
{
    VCTR_TEST_DEFINES_NO_ZEROS (10)
